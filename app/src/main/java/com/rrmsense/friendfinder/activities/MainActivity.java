...
import com.rrmsense.friendfinder.fragments.AddFragment;
...
import com.rrmsense.friendfinder.fragments.ViewFragment;
...
//        }
        ...
        FirebaseDatabase.getInstance().getReference("notification").child(user.getUid()).addChildEventListener(new ChildEventListener() {
            @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        notificationCount = (TextView) action_notification.findViewById(R.id.count);
        notificationButton = (Button) action_notification.findViewById(R.id.action);
        action_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                SharedPreferences.Editor editor = preferences.edit();
                editor.putString("NotificationCount", "");
                editor.apply();
                notificationCount.setText("");
                if (CURRENT_FRAGMENT != Fragments.FRAGMENT_NOTIFICATION)
                    openFragment(Fragments.FRAGMENT_NOTIFICATION);
            }
        });
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
        String count = preferences.getString("NotificationCount", "1");
